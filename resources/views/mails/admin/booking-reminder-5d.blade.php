<html>
    ...
    <body>
        <div>
            ...
            <p>誠にありがとうございます。</p>
            <br/>
            <p>撮影会のお日にちが近づいて参りましたので、ご連絡差し上げました！</p>
            <br/>
            <p>◯リマインド</p>
        ...
        <div>
            <p>================</p>
            <p>■日時</p>
            <p>{{ $booking['event_date'] }}({{ $booking['event_day_of_week'] }})　{{ $booking['event_start_time'] }}〜{{ $booking['event_end_time'] }}</p>
            <br/>
            <p>■会場</p>
            <p>{{ $booking['place'] }}</p>
